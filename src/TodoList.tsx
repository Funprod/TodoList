...
export const TodoList = (props: TodoListPropsType) => {
    ...
    const task: Array<JSX.Element> = filterTasks.map((t) => {
        ...
        return (
            <ListItem key={t.id} disablePadding sx={ListItemSx}>
                <Box>
                ...
                <IconButton size="small" color="inherit" onClick={onRemoveHandler}>
                    <DeleteIcon />
                </IconButton>
            </ListItem>
        );
    ...
    return (
        <Box sx={filterButtonsContainerSx}>
            <h3>
                ...
                <IconButton size="small" color="inherit" onClick={removeTodolistHandler}>
                    <DeleteIcon />
                </IconButton>
            </h3>
